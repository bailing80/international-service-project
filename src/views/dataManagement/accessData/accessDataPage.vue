...
<template>
  <div class="page_view">
    ...
    <div class="page_body">
      ...
      <div class="">
        <div class="search">
          ...
          <el-button type="info" size="small" class="add-cenlit" @click="addClient">添加员工</el-button>
        </div>
        <div class="table">
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="name" label="姓名"></el-table-column>
            <el-table-column prop="age" label="名字"></el-table-column>
    ...
    <!-- 功能权限组件 -->
    <AuthFunctionPoint
      v-if="isAuthFunctionPoint"
      @dialogClose="dialogClose('isAuthFunctionPoint')"
    />
    <!-- 添加用户组件 -->
    <AddStaff
      v-if="isAddStaff"
      @dialogClose="dialogClose('isAddStaff')"
...
import AuthFunctionPoint from "../menuInfo/authFunctionPoint";
import AddStaff from "./child/addStaff";
export default {
  name: "staffAdminPage",
  data() {
    return {
